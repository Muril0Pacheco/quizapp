        ...
        <section class="alternativas">
            <form action="">
                <label for="alternativa_a">
                    <input type="radio" id="alternativa_a" name="aleternativa">
                ...
                <label for="alternativa_b">
                    <input type="radio" id="alternativa_b" name="aleternativa">
                ...
                <label for="alternativa_c">
                    <input type="radio" id="alternativa_c" name="aleternativa">
                ...
                <label for="alternativa_d">
                    <input type="radio" id="alternativa_d" name="aleternativa">
